-- Agora — parish seed for D1. GENERATED by scripts/gen-seed-sql.js.
-- Edit seeds/parishes.js and re-run; do not hand-edit this file.
--
--   wrangler d1 execute agora --remote --file=d1/seed-parishes.sql
--
-- Every seeded parish is in NSW, so the Australia/Sydney default applies.
-- A parish outside that zone must set timezone explicitly.

INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -33.891, 151.2089, 'https://stgeorgecathedral.com.au/', '["Arabic", "English"]', '#1e3a5f',
...
INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -33.9222, 151.0546, 'https://stnicholaspunchbowl.org.au/', '["Arabic", "English"]', '#1e3a5f',
...
INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -33.82, 150.9909, 'https://www.saintmary.org.au/', '["English", "Arabic"]', '#1e3a5f',
...
INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -33.8181, 151.0986, 'https://smg.org.au/', '["English", "Arabic"]', '#1e3a5f',
...
INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -33.916, 151.0287, 'https://www.stnicholas-bankstown.org/', '["Arabic", "English"]', '#1e3a5f',
...
INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -33.7485, 150.8719, NULL, '["Arabic", "English"]', '#1e3a5f',
  'import', 'seeds/parishes.js'
) ON CONFLICT(id) DO NOTHING;
INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -33.8997, 151.1017, 'https://stjohnthebaptist.church/', '["Arabic", "English"]', '#1e3a5f',
...
INSERT INTO parishes (id, name, full_name, jurisdiction, address, lat, lng, website, languages, color, info_source_type, info_source_ref) VALUES (
  ...
  -34.4364, 150.8905, 'https://www.saintelias.org.au/', '["Arabic", "English"]', '#1e3a5f',

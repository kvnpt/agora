...
1. Extract parish identification signals — do NOT attempt to match against any list, just describe what you see:
   - saint_name: the HOSTING CHURCH's dedication — extract VERBATIM whatever the parish is called. This is NOT limited to saints with "St" in front. Many Orthodox parishes are dedicated to a feast, mystery, or title of the Theotokos. Examples of valid saint_name values: "St John the Baptist", "St Nicholas", "Holy Dormition", "Dormition of the Most Holy Mother of God", "Holy Cross", "Annunciation", "Theotokos", "Holy Trinity", "Transfiguration", "Resurrection", "Holy Apostles", "Three Hierarchs", "Archangel Michael", "Prophet Elias", "Protection of the Most Holy Theotokos". NOT a saint mentioned in an event title, ministry name, or group name (e.g. "St Joseph Men's Group" hosted at St John the Baptist → saint_name is "St John the Baptist"). If a caption or text message names a parish, that takes priority over anything visible in a poster image. Look for venue indicators at the bottom of posters (church name, address, "hosted by") to identify the host. null only if no church dedication is identifiable.

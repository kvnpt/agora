...
Only include schedules if the message describes RECURRING weekly services, not one-off events. If you extract a service as a schedule entry, do NOT also emit it as an event — schedules generate their own events automatically. A service is either a schedule OR an event, never both.

// The date lens: expand recurring `schedules` into event instances at query
// time, applying `schedule_overrides`. Ported from schedule-expand.js.
//
...
// Parish columns mirrored onto every instance, matching the joins the API
// already returns for stored events.
const PARISH_COLS = `
